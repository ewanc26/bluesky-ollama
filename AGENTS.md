...
Guidance for AI coding agents working in **bluesky-ollama**.

## Project overview

An AI-powered Bluesky bot that uses Ollama to generate posts based on content from a source account.
